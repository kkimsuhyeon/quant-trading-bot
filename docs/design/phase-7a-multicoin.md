...
| BTC 단독 | +50% | -46% | 0.42 |
| 전체 포트(10) | +24% | -50% | 0.30 |
| alt 바스켓(9) | +21% | -52% | 0.28 |
- 수익>0 코인 6/10 · 평균 상관 **0.35** · 구간방어 **2/5**
- → **악화** (수익↓, MDD 소폭↓, Sharpe↓).
...
|---|---|---|---|
| BTC 단독 | +45% | -53% | 0.39 |
| **전체 포트(10)** | **+103%** | **-40%** | **0.58** |
| alt 바스켓(9) | +110% | -41% | 0.59 |
- 수익>0 코인 8/10 · 평균 상관 **0.38** · 구간방어 **3/5**
- → **도움(수익·낙폭 다 개선).**

## 판정 (4전략 전부)
- Primary 기준(BTC단독 대비 MDD↓·Sharpe↑·수익 안 망가짐) — **2:2로 갈림:**
  - **악화**: Regime(MDD -35→-60), Donchian(+50→+24/-46→-50)
  - **개선**: Keltner(낙폭만 -37→-28), SMA+손절(+45→+103/-53→-40, 전 축 개선)
- **★규칙성:** *BTC에서 이미 강했던* 전략(Regime +203, Donchian +50)은 분산이 끌어내리고, *BTC에서 약했던* 전략(SMA+손절 +45)은 분산이 끌어올린다.
  → 다코인 분산은 **"엣지를 더하는" 게 아니라 *코인 평균으로 수렴*시키는 것.** (BTC가 그 전략에서 운 좋게 강했으면 ↓, 약했으면 ↑.)
  어느 전략의 BTC버전이 강/약일지 **미리 알 수 없으니** 실전 레버가 못 된다.
- → **다코인 현물 분산은 우리 엣지를 신뢰성 있게 개선하지 못한다 (평균화일 뿐).**
